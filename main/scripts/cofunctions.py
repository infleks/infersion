...
def cusHistToJSON():
    ...
    for i,c in enumerate(cus):
        ...
        cusArr[-1].append('<td><a class=\\\"benima\\\" id=\\\"delete\\\"  onclick = \\\"deleteControlForCustomerHis(' + str(c.pk) + ')  \\\" style=\\\" cursor: pointer;\\\"><i class=\\\"fas fa-trash-alt\\\" style=\\\"color: #be5254; font-size:20px; cursor: pointer;\\\"></i>Sil</a></td>')
...
def prodHistTestHistToJSON():
    ...
    for i,p in enumerate(pH):
        if p.customer.customerSituation == "Aktif":
            ...
            pArr[-1].append('<td><a class=\\\"benima\\\" id=\\\"delete\\\" onclick = \\\"deleteControlForProdHis(' + str(p.pk) + ')  \\\" style=\\\" cursor: pointer;\\\"><i class=\\\"fas fa-trash-alt\\\" style=\\\"color: #be5254; font-size:20px; cursor: pointer;\\\"></i>Sil</a></td>')
    ...
    for i,p in enumerate(tpH):
        if p.customer.customerSituation == "Aktif":
            ...
            tpArr[-1].append('<td><a class=\\\"benima\\\" id=\\\"delete\\\" onclick = \\\"deleteControlForTestHis(' + str(p.pk) + ')  \\\" style=\\\" cursor: pointer;\\\"><i class=\\\"fas fa-trash-alt\\\" style=\\\"color: #be5254; font-size:20px; cursor: pointer;\\\"></i>Sil</a></td>')
